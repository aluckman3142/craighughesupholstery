...
<table border-spacing="0" style="width: 100%; border: solid 1px #d4d4d4; font-family: 'Nunito', sans-serif;">
    ...
    <tr style="color:#888; background-color: #d4d4d4;">
        <td style="text-align: center; padding: 40px"  colspan="4">
            <h2 style="font-weight: lighter;">A New Order has been placed on the Craig Hughes Upholstery Website</h2>
    ...
    <tr style="color:#888; background-color: #FFF;">
        <td style="text-align: left; padding: 15px"  colspan="4">
            <a href="{{'https://www.craighughesupholstery.co.uk/dashboard/orders'}}" target="_blank" style="text-decoration:none; margin-bottom: 30px; border:none; color:#FFF; padding: 15px; background-color: #0dcaf0;">Click here to view the order.</a>
        </td>
    </tr>
    <tr>
        <td>&nbsp;</td>
