<x-app-layout>
    ...
    <div class="m-5">
        ...
        <form name="add-category-image-form" id="add-category-image-form" method="post" action="{{ URL::to('dashboard/category-images/store') }}">
            @csrf
            ...
            <button type="submit" class="btn btn-success btn-sm uppercase">Add Category Image</button>
        </form>
