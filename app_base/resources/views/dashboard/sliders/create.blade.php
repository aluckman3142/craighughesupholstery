<x-app-layout>
    ...
    <div class="m-5">
        ...
        <form name="add-slide-form" id="add-slide-form" method="post" action="{{ URL::to('dashboard/sliders/store') }}">
            @csrf
            ...
            <button type="submit" class="btn btn-success btn-sm uppercase">Add Slide</button>
        </form>
    </div>
